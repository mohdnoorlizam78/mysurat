                ...
                <div class="box-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nombor" name="nombor" type="text" value="{{ $data_stt->nombor}}" class="form-control">
                        </div> 
                        <div class="form-group">
                            <label for="tarikh_penerimaan">Tarikh terima surat</label>                            
                            <input type="date" name="tarikh_penerimaan" value="{{$data_stt->tarikh_penerimaan }}" class="form-control">
                        </div> 
                        <div class="form-group">
                            <label for="no_fail_kementerian_ibu_pejabat">No Fail Kementerian Ibu Pejabat</label>
                            <input id="no_fail_kementerian_ibu_pejabat" name="no_fail_kementerian_ibu_pejabat" type="text" value="{{$data_stt->no_fail_kementerian_ibu_pejabat }}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="nombor_yang_lain">Nombor Yang Lain</label>
                            <input id="nombor_yang_lain" name="nombor_yang_lain" type="text" value="{{$data_stt->nombor_yang_lain }}" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input id="dirujukkan_kepada" name="dirujukkan_kepada" type="text" value="{{$data_stt->dirujukkan_kepada }}" class="form-control">
                        </div>
                        <div class="form-group">
