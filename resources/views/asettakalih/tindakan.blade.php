...
<ol class="breadcrumb mb-4">
    ...
    <li class="breadcrumb-item"><a href="{{url('asettakalih/tindakan')}}">Tindakan Siasatan Aduan Kerosakan</a></li>
...
<table style="width:80%" >
  ...
  <tbody class="form-group">  
    ...
    <tr>
        ...
        <input id="jenis_kerja_id" name="jenis_kerja_id" value="{{$data_laporrosak->jeniskerja->nama_kerja}}" class="form-control" readonly>                        
    ...
    <tr>
        ...
        <input id="ditugaskan_id" name="ditugaskan_id" value="{{$data_laporrosak->pegawaipenerima->name}}" class="form-control" readonly>                        
    ...
    <tr>
        ...
        <td style="width: 50%;">
        <input type="date" name="tarikh_ditugaskan" value="{{ $data_laporrosak->tarikh_ditugaskan }}" readonly>
    ...
    <tr>
        ...
        <td style="width: 50%;">
        <input type="time" name="masa_ditugaskan" value="{{ $data_laporrosak->masa_ditugaskan }}" readonly>
    ...
    <tr>
        ...
        <td style="width: 50%;">
            <input id="ulasan_rosak" type="text" value="{{ $data_laporrosak->ulasan_rosak }}" name="ulasan_rosak" class="form-control" readonly >                        
        </td>
    </tr>
    ...
    <tr>
        ...
        <td style="width: 50%;">
          <input id="jenis_alat_ganti" type="text" value="{{ $data_laporrosak->jenis_alat_ganti }}" name="jenis_alat_ganti" class="form-control" readonly >                        
        </td>
    </tr>
    <tr>
        <td style="width: 10%;">Keterangan Alat Ganti</td>
        <td style="width: 50%;">
          <input id="keterangan_alat_ganti" type="text" value="{{ $data_laporrosak->keterangan_alat_ganti }}" name="keterangan_alat_ganti" class="form-control" readonly >                        
        </td>
    </tr>
    <tr>
        <td style="width: 10%;">Harga Alat Ganti</td>
        <td style="width: 50%;">
          <input id="harga_seunit_alat" type="number" value="{{ $data_laporrosak->harga_seunit_alat }}" name="harga_seunit_alat" class="form-control" readonly>                        
        </td>
    </tr>
    <tr>
        <td style="width: 10%;">Kuantiti</td>
        <td style="width: 50%;">
          <input id="kuantiti_alat" type="number" value="{{ $data_laporrosak->kuantiti_alat }}" name="kuantiti_alat" class="form-control" readonly >                        
        </td>
    </tr>
    <tr>
        <td style="width: 10%;">Jumlah</td>
        <td style="width: 50%;">
          <input id="jumlah_alat" type="number" value="{{ $data_laporrosak->jumlah_alat }}" name="jumlah_alat" class="form-control" readonly >                        
        </td>
    </tr>
    ...
    <tr>
        ...
        <td style="width: 50%;">
          <input id="perihal_kerja" type="text" value="{{ $data_laporrosak->perihal_kerja }}" name="perihal_kerja" class="form-control" readonly >                        
        </td>
    </tr>
    <tr>
        ...
        <input type="datetime-local" name="tarikh_mula" value="{{ $data_laporrosak->tarikh_mula }}" readonly>
    ...
    <tr>
        ...
        <td style="width: 50%;">
        <input type="datetime-local" name="tarikh_siap" value="{{$data_laporrosak->tarikh_siap}}" readonly>
    ...
    <tr>
        ...
        <td style="width: 50%;">
          <input id="nama_kontraktor" type="text" value="{{ $data_laporrosak->nama_kontraktor }}" name="nama_kontraktor" class="form-control" readonly >                        
        </td>
    </tr>
    <tr>
        <td style="width: 10%;">Tarikh Mula Kerja</td>
        <td style="width: 50%;">
        <input type="date" name="tarikh_mula_kon" value="{{ $data_laporrosak->tarikh_mula_kon }}" readonly>
    ...
    <tr>
        ...
        <td style="width: 50%;">
        <input type="date" name="tarikh_siap_kon" value="{{ $data_laporrosak->tarikh_siap_kon }}" readonly>
    ...
    <tr>
        ...
        <td style="width: 50%;">
          <input id="kos_akhir" type="number" value="{{ $data_laporrosak->kos_akhir }}" name="kos_akhir" class="form-control" readonly >                        
        </td>
    </tr>
    <tr>
        <td style="width: 10%;">Tempoh Tanggungan</td>
        <td style="width: 50%;">
          <input id="tempoh_tanggungan" type="text" value="{{ $data_laporrosak->tempoh_tanggungan }}" name="tempoh_tanggungan" class="form-control" readonly  >                        
        </td>
    </tr>
    ...
    <a href="{{ url('asettakalih/tindakan/tindakanpdf', $data_laporrosak->id) }} " target="_blank" style="color:red" class="btn btn-info btn-sm"><i class="far fa-file-pdf"></i>&nbsp Cetak Laporan</a>
